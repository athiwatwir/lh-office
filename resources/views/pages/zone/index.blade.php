        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white">
            ...
            @if ($data->isEmpty())
                <div class="px-5 py-16 text-center sm:px-6">
                    <p class="text-base font-medium text-gray-800">ยังไม่มีโซน</p>
                    <p class="mt-1 text-sm text-gray-500">เริ่มต้นด้วยการเพิ่มโซนใหม่</p>
                </div>
            @else
                        ...
                        <thead>
                            <tr class="border-y border-gray-100">
                                <th class="px-5 py-3 text-start font-normal sm:px-6">
                                    <span class="text-theme-sm text-gray-500">ชื่อโซน</span>
                                </th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($data as $item)
                                ...
                                <tr class="hover:bg-gray-50/60">
                                    ...
                                    <td class="px-4 py-4">
                                        <span class="text-theme-sm text-gray-600">{{ $item->description ?: '-' }}</span>
                                    </td>
                                    <td class="px-4 py-4">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            @else
                                                <form
                                                    method="POST"
                                                    action="{{ route('zone.destroy', $item) }}"
