...
<form method="POST" action="{{ $action }}" enctype="multipart/form-data" class="px-5 py-6 sm:px-6">
    ...
    <div class="mt-6 flex flex-wrap items-center gap-3">
        ...
        <a href="{{ route('propertyType.index') }}" class="inline-flex h-11 items-center justify-center rounded-lg border border-gray-300 bg-white px-5 text-sm font-medium text-gray-700 shadow-theme-xs transition hover:bg-gray-50">
            ยกเลิก
        </a>
    </div>
</form>
