        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white">
            <div class="flex flex-col gap-4 border-b border-gray-200 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                ...
                <div class="inline-flex rounded-lg border border-gray-200 bg-gray-50 p-1">
                    <a
                        href="{{ route('propertyRequest.index', ['type' => 'buy']) }}"
                        @class([
                            'rounded-md px-4 py-2 text-sm font-medium transition',
                            'bg-white text-gray-800 shadow-theme-xs' => $type === 'buy',
                    ...
                    <a
                        href="{{ route('propertyRequest.index', ['type' => 'sell']) }}"
                        @class([
                            'rounded-md px-4 py-2 text-sm font-medium transition',
                            'bg-white text-gray-800 shadow-theme-xs' => $type === 'sell',
