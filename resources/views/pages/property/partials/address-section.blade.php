...
<section>
    <h4 class="mb-4 text-base font-semibold text-gray-800">ปักหมุดบนแผนที่</h4>
    ...
    <p class="mt-2 text-theme-xs text-gray-500">คลิกบนแผนที่หรือลากหมุดเพื่อกำหนดตำแหน่งทรัพย์</p>
</section>
